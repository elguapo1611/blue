      ...
      capistrano_config.load do
        ...
        namespace :blue do
          ...
          task :apply_manifest, :except => { :no_release => true } do
            ...
            run "sudo su - -c 'cd #{latest_release} && RAILS_ROOT=#{latest_release} RAILS_ENV=#{Blue.env} bundle exec shadow_puppet #{latest_release}/config/blue/boxes/#{Blue.env}/#{current_host}.rb'"
          end
